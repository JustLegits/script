-- Credit to z4gs https://github.com/z4gs

local gui = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/JustLegits/script/refs/heads/main/RoGhoul_UI.lua"))():AddWindow("Ro-Ghoul", {
...
local myData = loadstring(game:HttpGet("https://raw.githubusercontent.com/JustLegits/script/refs/heads/main/RoGhoul_Settings.lua"))()("Ro-Ghoul Autofarm", {
    Skills = {
        E = false,
        F = false,
        C = false,
